...
\item Automatisation du codage (séances, hospitalisations courtes), programmation d’une interface H'XML pour l'intégration  des diagnostics automatisée dans le logiciel PMSI
...
\item Algorithmes de machine learning et de traitement automatisé du langage appliqués à la classification de compte-rendus hospitaliers pour aider au codage PMSI
...
\end{itemize}
\item Automatisation du rapport annuel d'activité du champ d'activité HAD au niveau national en convention avec la FNEHAD
\end{itemize}
\end{itemize}}
