...
\usepackage[top=1cm, bottom=1.2cm, left=1cm, right=1.2cm]{geometry}
\usepackage{enumitem}
...
\photo[50pt][0.4pt]{photo2_bw.png}
...
\cventry{2019 -- 2023}{CHRU de Brest}{GHT Bretagne Occidentale}{Brest}{}{
\vspace{0.1mm}
...
\item Suivis automatisés des processus de la donnée (relances des services, exhaustivité, qualité)
\item Automatisation du codage (séances, hospitalisations courtes), programmation d’une interface H'XML pour l'intégration automatisée des diagnostics dans le logiciel PMSI
\item Veille réglementaire et technique
\item Études ciblées : potentiels de la gradation dans les HDJ, projections d’activités pour le schéma directeur immobilier 
...
\item Nouvel entrepôt de données de santé (EDS : bases de données, data lake, fichiers parquet) : co-construction et alimentation
...
\vspace{0.1mm}
\begin{itemize}[leftmargin=-0.5in]
\item Au sein du département d'information médicale (SIMAP) du Siège de l’AP-HP
\begin{itemize}[leftmargin=0.4in]
...
\item Communication et poster congrès Emois : Approche géo-populationnelle de la précarité à partir du PMSI et de données Insee (indicateur FDep) ; Chimiothérapie et décès pour cancer métastatique
\item Algorithmes de machine learning et de traitement automatisé du langage appliqués à la classification de comptes-rendus hospitaliers pour aider au codage PMSI
...
\end{itemize}
\item Automatisation du rapport annuel d'activité du champ HAD au niveau national en convention avec la FNEHAD (Fédération nationale des établissements d'hospitalisation à domicile)
\end{itemize}
\end{itemize}}
...
\cvitem{2007 -- 2008}{Cours particuliers de mathématiques à des élèves de collège, lycée et niveau universitaire}{}{}
